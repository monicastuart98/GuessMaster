...
//	public compBirthDate(String name, com.example.monica.guessmaster.Date birthDate) {
//		this.name = name;
//		this.birthDate = new com.example.monica.guessmaster.Date(birthDate); //no privacy leak
//	}
//
//	public compBirthDate(String name, com.example.monica.guessmaster.Date birthDate) {
//		this.name = name;
//		this.birthDay = new com.example.monica.guessmaster.Date(birthDay); //no privacy leak
//	}
